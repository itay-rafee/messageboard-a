...
namespace ariel
{
    ...
    string Board::read_h(unsigned int row, unsigned int col, int len)
    {
        string ans;
    ...
    string Board::read_v(unsigned int row, unsigned int col, int len)
    {
        string ans;
        for (size_t i = 0; i < len; i++)
        {
    ...
    string Board::read(unsigned int row, unsigned int col, Direction n, int len)
    {
        string ans;
        if (n == Direction::Horizontal)
        {
