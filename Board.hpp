...
namespace ariel
{
    ...
    private:
        ...
        std::string read_h(unsigned int row, unsigned int col, int len);
        std::string read_v(unsigned int row, unsigned int col, int len);
    ...
    public:
        ...
        std::string read(unsigned int row, unsigned int column, ariel::Direction n, int len);
        void show();
    };
}